...
A frontend-based phishing URL detection tool built using **HTML, CSS, and JavaScript**, designed to demonstrate basic **security analysis logic** with an interactive scanning interface.
## 🚀 Overview
